...
Generated 2026-09-14 · [live JSON](data/v1/coverage.json)
...
| Postings fetched | 21,373 |
| Postings published | 352 |
...
<details><summary><b>ElevenLabs</b> — 246 postings read, none early-career</summary>
...
<details><summary><b>Harvey</b> — 316 postings read, none early-career</summary>
...
<details><summary><b>OpenAI</b> — 800 postings read, none early-career</summary>
...
<details><summary><b>Perplexity</b> — 116 postings read, none early-career</summary>
...
<details><summary><b>Reflection AI</b> — 53 postings read, none early-career</summary>
...
- `Sr / Staff Machine Learning Engineer — not a US location`
- `Senior Legal Counsel- Privacy — not a US location`
- `Lead Applied Researcher, Express AI Foundations — not a US location`
...
<details><summary><b>Brex</b> — 269 postings read, none early-career</summary>
...
<details><summary><b>Cloudflare</b> — 345 postings read, none early-career</summary>
...
- `Business Development Representative, ASEAN (Vietnamese speaking) — not a US location`
...
<details><summary><b>Luma AI</b> — 44 postings read, none early-career</summary>
...
<details><summary><b>Mercury</b> — 60 postings read, none early-career</summary>
...
<details><summary><b>MongoDB</b> — 387 postings read, none early-career</summary>
...
- `Principal Systems Software Engineer, Semiconductor Systems Inspection — senior/experienced role`
- `Senior Software Engineer, Open Harness Engineering — not a US location`
- `Senior Technical Program Manager - Nemotron — non-technical role`
- `Senior Software Release Manager, DOCA — not a US location`
- `Senior ASIC Design Engineer — senior/experienced role`
- `Senior Architect, GPU and SoC Modeling — title is not a technical role`
...
|:--|:-:|:--|--:|--:|:--|
| [Scale AI](https://scale.com/careers) | 0 | `greenhouse:scaleai` | 227 | 4 | ✅ ok |
| [Stripe](https://stripe.com/jobs/university) | 0 | `greenhouse:stripe` | 628 | 4 | ✅ ok |
| [Anthropic](https://www.anthropic.com/careers) | 0 | `greenhouse:anthropic` | 590 | 3 | ✅ ok |
...
| [Anysphere (Cursor)](https://cursor.com/careers) | 0 | `ashby:cursor` | 125 | 1 | ✅ ok |
...
| [Harvey](https://www.harvey.ai/careers) | 0 | `ashby:harvey` | 316 | — | ○ none matched |
...
| [OpenAI](https://openai.com/careers) | 0 | `ashby:openai` | 800 | — | ○ none matched |
| [Optiver](https://optiver.com/join-us/jobs/?location=us) | 0 | — | — | — | 🔗 link-only |
| [Perplexity](https://www.perplexity.ai/careers) | 0 | `ashby:perplexity` | 116 | — | ○ none matched |
| [Poolside](https://poolside.ai/careers) | 0 | `ashby:poolside` | 8 | — | ○ none matched |
| [Reflection AI](https://reflection.ai/careers) | 0 | `ashby:reflectionai` | 53 | — | ○ none matched |
...
| [Palantir](https://www.palantir.com/careers/) | 1 | `lever:palantir` | 312 | 48 | ✅ ok |
| [SpaceX](https://www.spacex.com/careers/) | 1 | `greenhouse:spacex` | 2402 | 33 | ✅ ok |
...
| [Anduril Industries](https://www.anduril.com/careers/) | 1 | `greenhouse:andurilindustries` | 2185 | 10 | ✅ ok |
| [DRW](https://drw.com/work-at-drw/) | 1 | `greenhouse:drweng` | 155 | 10 | ✅ ok |
| [Waymo](https://waymo.com/careers/) | 1 | `greenhouse:waymo` | 321 | 10 | ✅ ok |
| [Old Mission Capital](https://www.oldmissioncapital.com/careers/) | 1 | `greenhouse:oldmissioncapital` | 38 | 9 | ✅ ok |
| [Coinbase](https://www.coinbase.com/careers) | 1 | `greenhouse:coinbase` | 207 | 8 | ✅ ok |
...
| [Schonfeld](https://www.schonfeld.com/careers/) | 1 | `greenhouse:schonfeld` | 69 | 7 | ✅ ok |
| [Amazon](https://www.amazon.jobs/en/teams/internships-for-students) | 1 | `amazon:amazon` | 6 | 6 | ✅ ok |
| [Notion](https://www.notion.so/careers) | 1 | `ashby:notion` | 126 | 6 | ✅ ok |
| [Robinhood](https://careers.robinhood.com/) | 1 | `greenhouse:robinhood` | 155 | 5 | ✅ ok |
...
| [Roblox](https://careers.roblox.com/) | 1 | `greenhouse:roblox` | 224 | 4 | ✅ ok |
| [Tower Research Capital](https://www.tower-research.com/open-positions/) | 1 | `greenhouse:towerresearchcapital` | 87 | 4 | ✅ ok |
| [Etched](https://www.etched.com/careers) | 1 | `ashby:etched` | 104 | 3 | ✅ ok |
| [Figma](https://www.figma.com/careers/) | 1 | `greenhouse:figma` | 158 | 3 | ✅ ok |
...
| [Datadog](https://careers.datadoghq.com/) | 1 | `greenhouse:datadog` | 423 | 1 | ✅ ok |
| [DoorDash](https://careers.doordash.com/) | 1 | `greenhouse:doordashusa` | 449 | 1 | ✅ ok |
...
| [Squarepoint Capital](https://www.squarepoint-capital.com/careers) | 1 | `greenhouse:squarepointcapital` | 95 | 1 | ✅ ok |
...
| [Cloudflare](https://www.cloudflare.com/careers/) | 1 | `greenhouse:cloudflare` | 345 | — | ○ none matched |
...
| [Luma AI](https://lumalabs.ai/careers) | 1 | `ashby:lumaai` | 44 | — | ○ none matched |
| [Mercury](https://mercury.com/jobs) | 1 | `greenhouse:mercury` | 60 | — | ○ none matched |
...
| [MongoDB](https://www.mongodb.com/company/careers) | 1 | `greenhouse:mongodb` | 387 | — | ○ none matched |
| [NVIDIA](https://www.nvidia.com/en-us/about-nvidia/careers/) | 1 | `workday:nvidia` | 40 | — | ○ none matched |
| [Plaid](https://plaid.com/careers/) | 1 | `ashby:plaid` | 111 | — | ○ none matched |
...
| [Ramp](https://ramp.com/careers) | 1 | `ashby:ramp` | 144 | — | ○ none matched |
...
| [Suno](https://suno.com/careers) | 1 | `ashby:suno` | 64 | — | ○ none matched |
...
| [Together AI](https://www.together.ai/careers) | 1 | `greenhouse:togetherai` | 63 | — | ○ none matched |
| [Vanta](https://www.vanta.com/careers) | 1 | `ashby:vanta` | 99 | — | ○ none matched |
...
| [Intel](https://jobs.intel.com/) | 2 | `workday:intel` | 21 | 3 | ✅ ok |
| [Samsara](https://www.samsara.com/company/careers/) | 2 | `greenhouse:samsara` | 248 | 3 | ✅ ok |
| [Nuro](https://www.nuro.ai/careers) | 2 | `greenhouse:nuro` | 105 | 2 | ✅ ok |
...
| [Flexport](https://www.flexport.com/careers/) | 2 | `greenhouse:flexport` | 174 | 1 | ✅ ok |
| [Grafana Labs](https://grafana.com/about/careers/) | 2 | `greenhouse:grafanalabs` | 113 | 1 | ✅ ok |
...
| [Affirm](https://www.affirm.com/careers) | 2 | `greenhouse:affirm` | 166 | — | ○ none matched |
| [Airtable](https://www.airtable.com/careers) | 2 | `greenhouse:airtable` | 16 | — | ○ none matched |
| [Amplitude](https://amplitude.com/careers) | 2 | `greenhouse:amplitude` | 34 | — | ○ none matched |
...
| [Chime](https://www.chime.com/careers/) | 2 | `greenhouse:chime` | 69 | — | ○ none matched |
| [ExodusPoint](https://www.exoduspoint.com/careers) | 2 | `greenhouse:exoduspoint` | 2 | — | ○ none matched |
| [Faire](https://www.faire.com/careers) | 2 | `greenhouse:faire` | 66 | — | ○ none matched |
| [Fastly](https://www.fastly.com/about/careers) | 2 | `greenhouse:fastly` | 46 | — | ○ none matched |
| [Gong](https://www.gong.io/careers/) | 2 | `greenhouse:gongio` | 83 | — | ○ none matched |
| [Gusto](https://gusto.com/about/careers) | 2 | `greenhouse:gusto` | 95 | — | ○ none matched |
| [Instacart](https://instacart.careers/) | 2 | `greenhouse:instacart` | 103 | — | ○ none matched |
| [Klaviyo](https://careers.klaviyo.com/) | 2 | `greenhouse:klaviyo` | 135 | — | ○ none matched |
| [Man Group](https://www.man.com/careers) | 2 | `greenhouse:mangroup` | 49 | — | ○ none matched |
| [Marshall Wace](https://www.mwam.com/careers/) | 2 | `greenhouse:marshallwace` | — | — | ○ board empty |
| [Mixpanel](https://mixpanel.com/careers/) | 2 | `greenhouse:mixpanel` | 86 | — | ○ none matched |
| [Pinterest](https://www.pinterestcareers.com/) | 2 | `greenhouse:pinterest` | 182 | — | ○ none matched |
...
| [Temporal](https://temporal.io/careers) | 2 | `ashby:temporal` | 71 | — | ○ none matched |
