...
Generated 2026-09-11 · [live JSON](data/v1/coverage.json)
...
| Postings fetched | 21,268 |
| Postings published | 334 |
| Boards that failed to fetch | **1** |
| Boards live but with nothing early-career | 67 |
...
<details><summary><b>Harvey</b> — 327 postings read, none early-career</summary>
...
<details><summary><b>Reflection AI</b> — 50 postings read, none early-career</summary>
...
- `Sr. Manager, M&A Product Integration — not a US location`
- `Staff Machine Learning Engineer — not a US location`
...
<details><summary><b>Brex</b> — 270 postings read, none early-career</summary>
...
<details><summary><b>MongoDB</b> — 388 postings read, none early-career</summary>
...
- `Senior Test Developer – Automotive Simulation Testing & Failure-Triage Lead — not a US location`
- `System Application Engineer (RDSS Intern) — not a US location`
- `Senior Software Architect - Data Center Systems — not a US location`
- `Senior Linux Kernel Systems Software Engineer – CSP Engagements — not a US location`
- `Director, Perception - Autonomous Vehicles — senior/experienced role`
- `Solutions Architect - NVIDIA Cloud Partners and Datacentre Infrastructure — not a US location`
...
|:--|:-:|:--|--:|--:|:--|
| [Scale AI](https://scale.com/careers) | 0 | `greenhouse:scaleai` | 222 | 4 | ✅ ok |
| [Stripe](https://stripe.com/jobs/university) | 0 | `greenhouse:stripe` | 617 | 4 | ✅ ok |
| [Anthropic](https://www.anthropic.com/careers) | 0 | `greenhouse:anthropic` | 593 | 3 | ✅ ok |
...
| [xAI](https://x.ai/careers) | 0 | `greenhouse:xai` | 252 | 1 | ✅ ok |
...
| [Harvey](https://www.harvey.ai/careers) | 0 | `ashby:harvey` | 327 | — | ○ none matched |
...
| [Reflection AI](https://reflection.ai/careers) | 0 | `ashby:reflectionai` | 50 | — | ○ none matched |
...
| [SpaceX](https://www.spacex.com/careers/) | 1 | `greenhouse:spacex` | 2359 | 30 | ✅ ok |
...
| [Point72 / Cubist](https://careers.point72.com/) | 1 | `greenhouse:point72` | 218 | 11 | ✅ ok |
...
| [Waymo](https://waymo.com/careers/) | 1 | `greenhouse:waymo` | 335 | 7 | ✅ ok |
...
| [Roblox](https://careers.roblox.com/) | 1 | `greenhouse:roblox` | 227 | 4 | ✅ ok |
| [Tower Research Capital](https://www.tower-research.com/open-positions/) | 1 | `greenhouse:towerresearchcapital` | 86 | 4 | ✅ ok |
...
| [Netflix](https://explore.jobs.netflix.net/careers) | 1 | `eightfold:netflix.com` | 493 | 3 | ✅ ok |
...
| [Baseten](https://www.baseten.co/careers) | 1 | `ashby:baseten` | 94 | 1 | ✅ ok |
...
| [Figma](https://www.figma.com/careers/) | 1 | `greenhouse:figma` | 156 | 1 | ✅ ok |
...
| [Brex](https://www.brex.com/careers) | 1 | `greenhouse:brex` | 270 | — | ○ none matched |
...
| [Robinhood](https://careers.robinhood.com/) | 1 | `greenhouse:robinhood` | 129 | — | ○ none matched |
...
| [SambaNova](https://sambanova.ai/careers) | 1 | `greenhouse:sambanovasystems` | 56 | — | ○ none matched |
...
| [Together AI](https://www.together.ai/careers) | 1 | `greenhouse:togetherai` | 62 | — | ○ none matched |
| [Vanta](https://www.vanta.com/careers) | 1 | `ashby:vanta` | 104 | — | ○ none matched |
| [Verkada](https://www.verkada.com/careers/) | 2 | `greenhouse:verkada` | 293 | 12 | ✅ ok |
...
| [Elastic](https://www.elastic.co/careers) | 2 | `greenhouse:elastic` | 353 | 1 | ✅ ok |
| [Flexport](https://www.flexport.com/careers/) | 2 | `greenhouse:flexport` | 172 | 1 | ✅ ok |
| [Grafana Labs](https://grafana.com/about/careers/) | 2 | `greenhouse:grafanalabs` | 124 | 1 | ✅ ok |
...
| [Attentive](https://www.attentive.com/careers) | 2 | `greenhouse:attentive` | 34 | — | ○ none matched |
...
| [Gong](https://www.gong.io/careers/) | 2 | `greenhouse:gongio` | 87 | — | ○ none matched |
| [Gusto](https://gusto.com/about/careers) | 2 | `greenhouse:gusto` | 94 | — | ○ none matched |
| [Instacart](https://instacart.careers/) | 2 | `greenhouse:instacart` | 106 | — | ○ none matched |
| [Intel](https://jobs.intel.com/) | 2 | `workday:intel` | 15 | — | ○ none matched |
| [Klaviyo](https://careers.klaviyo.com/) | 2 | `greenhouse:klaviyo` | 128 | — | ○ none matched |
| [Lyft](https://www.lyft.com/careers) | 2 | `greenhouse:lyft` | 162 | — | ○ none matched |
...
| [Okta](https://www.okta.com/company/careers/) | 2 | `greenhouse:okta` | 305 | — | ○ none matched |
